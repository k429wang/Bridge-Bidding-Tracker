 ...
 */
public class accordionlist_example extends JPanel implements ActionListener {
    /**
    ...
    public static void main(String[] args) {
        ...
        accordionlist_example outlookBar = new accordionlist_example();
